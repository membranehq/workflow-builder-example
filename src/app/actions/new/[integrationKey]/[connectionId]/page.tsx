    ...
    const fetchData = async () => {
      try {
        ...
        const [collections, conn] = await Promise.all([
          integrationApp.integration(integrationKey as string).getDataCollections(),
        ...
        <div className='flex items-center space-x-4'>
          <div className='flex items-center space-x-3'>
            ...
            <div>
              ...
              <div className='text-lg font-medium text-gray-900 dark:text-white'>Select Collection</div>
            </div>
          </div>
        </div>
