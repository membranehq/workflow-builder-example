...
echo ""
echo "Services:"
echo "  - Temporal Server (gRPC API): http://localhost:7233"
echo "  - Temporal Web UI: http://localhost:8088"
echo "  - PostgreSQL: localhost:5432"
echo ""
echo "📱 IMPORTANT: Use http://localhost:8088 for the web interface!"
echo "   Port 7233 is for API calls only, not web browsing."
echo ""
echo "To view logs:"
